...
{
    public partial class entities_test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Author 1" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "Available", "Description", "ImageUrl", "Isbn", "OriginalPrice", "Pages", "Price", "PublicationYear", "Quantity", "Title" },
                values: new object[,]
                {
                    { 1, null, "Book description", null, null, null, null, null, null, 100, "Test book" },
                    { 2, null, "New description", null, null, null, null, null, null, 50, "book #2" }
                });
